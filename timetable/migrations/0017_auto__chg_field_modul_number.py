...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Modul.number'
        db.alter_column(u'timetable_modul', 'number', self.gf('django.db.models.fields.CharField')(max_length=256, unique=True, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Modul.number'
        raise RuntimeError("Cannot reverse this migration. 'Modul.number' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Modul.number'
        db.alter_column(u'timetable_modul', 'number', self.gf('django.db.models.fields.CharField')(max_length=256, unique=True))
