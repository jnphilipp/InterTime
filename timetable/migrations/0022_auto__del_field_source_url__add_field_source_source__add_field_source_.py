...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'timetable_source', 'url')

        # Adding field 'Source.source'
        db.add_column(u'timetable_source', 'source',
                      self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=1024),
                      keep_default=False)

        # Adding field 'Source.parser'
        db.add_column(u'timetable_source', 'parser',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['timetable.Parser']),
                      keep_default=False)


        # Changing field 'Source.regex'
        db.alter_column(u'timetable_source', 'regex', self.gf('django.db.models.fields.BooleanField')(default=''))

    def backwards(self, orm):
        # Adding field 'Source.url'
        db.add_column(u'timetable_source', 'url',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Source.source'
        db.delete_column(u'timetable_source', 'source')

        # Deleting field 'Source.parser'
        db.delete_column(u'timetable_source', 'parser_id')


        # Changing field 'Source.regex'
        db.alter_column(u'timetable_source', 'regex', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))
