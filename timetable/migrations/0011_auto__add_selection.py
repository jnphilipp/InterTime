...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'timetable_selection', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('student', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['timetable.Student'])),
        ))
        db.send_create_signal(u'timetable', ['Selection'])

        # Adding M2M table for field events on 'Selection'
        m2m_table_name = db.shorten_name(u'timetable_selection_events')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('selection', models.ForeignKey(orm[u'timetable.selection'], null=False)),
            ('event', models.ForeignKey(orm[u'timetable.event'], null=False))
        ))
        db.create_unique(m2m_table_name, ['selection_id', 'event_id'])


    def backwards(self, orm):
        # Deleting model 'Selection'
        db.delete_table(u'timetable_selection')

        # Removing M2M table for field events on 'Selection'
        db.delete_table(db.shorten_name(u'timetable_selection_events'))
