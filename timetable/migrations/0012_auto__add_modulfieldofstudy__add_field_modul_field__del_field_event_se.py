...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ModulFieldOfStudy'
        db.create_table(u'timetable_modulfieldofstudy', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('field_of_study', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['timetable.FieldOfStudy'])),
            ('semester_numbers', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=256, null=True)),
        ))
        db.send_create_signal(u'timetable', ['ModulFieldOfStudy'])
        ...
        # Deleting field 'Event.semester_numbers'
        db.delete_column(u'timetable_event', 'semester_numbers')


    def backwards(self, orm):
        # Deleting model 'ModulFieldOfStudy'
        db.delete_table(u'timetable_modulfieldofstudy')

        # Deleting field 'Modul.field'
        db.delete_column(u'timetable_modul', 'field_id')

        # Adding field 'Event.semester_numbers'
        db.add_column(u'timetable_event', 'semester_numbers',
                      self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=256, null=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'timetable.modul': {
            ...
            'field': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['timetable.ModulFieldOfStudy']", 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
