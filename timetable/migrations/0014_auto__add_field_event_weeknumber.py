...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.weeknumber'
        db.add_column(u'timetable_event', 'weeknumber',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.weeknumber'
        db.delete_column(u'timetable_event', 'weeknumber')
    ...
    models = {
        ...
        u'timetable.event': {
            ...
            'weeknumber': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
