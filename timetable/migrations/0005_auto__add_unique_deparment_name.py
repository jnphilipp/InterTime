...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Deparment', fields ['name']
        db.create_unique(u'timetable_deparment', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Deparment', fields ['name']
        db.delete_unique(u'timetable_deparment', ['name'])
