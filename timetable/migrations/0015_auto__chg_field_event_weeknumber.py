...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event.weeknumber'
        db.alter_column(u'timetable_event', 'weeknumber', self.gf('django.db.models.fields.CharField')(max_length=256))

    def backwards(self, orm):

        # Changing field 'Event.weeknumber'
        db.alter_column(u'timetable_event', 'weeknumber', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        u'timetable.event': {
            ...
            'weeknumber': ('django.db.models.fields.CharField', [], {'default': 'False', 'max_length': '256', 'blank': 'True'})
        },
