...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'timetable_fieldofstudy', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=256)),
            ('deparment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['timetable.Deparment'])),
        ))
        db.send_create_signal(u'timetable', ['FieldOfStudy'])


    def backwards(self, orm):
        # Deleting model 'FieldOfStudy'
        db.delete_table(u'timetable_fieldofstudy')
