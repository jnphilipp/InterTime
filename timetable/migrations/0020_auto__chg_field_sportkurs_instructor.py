...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Sportkurs.instructor'
        db.alter_column(u'timetable_sportkurs', 'instructor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['timetable.Instructor'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Sportkurs.instructor'
        raise RuntimeError("Cannot reverse this migration. 'Sportkurs.instructor' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Sportkurs.instructor'
        db.alter_column(u'timetable_sportkurs', 'instructor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['timetable.Instructor']))
